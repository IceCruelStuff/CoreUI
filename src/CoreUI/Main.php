...
class Main extends PluginBase implements Listener
{
    ...
    public function sendMenu($sender)
    { 
        ...
        $form->addButton(TextFormat::GRAY . "Enable Fly\n" . TextFormat::LIGHT_PURPLE . "Tap to Enable Fly");
        $form->addButton(TextFormat::GRAY . "Disable Fly\n" . TextFormat::LIGHT_PURPLE."Tap to Disable Fly");
